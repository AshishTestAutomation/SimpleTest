		...
		try {
			if (driver.findElement(By.className("nav__button-secondary")).isDisplayed() == true) {
				...
				try {
					...
					{
						driver.findElement(By.id("username")).sendKeys("youremailid");
						...
						driver.findElement(By.className("session_key")).sendKeys("youremailid");
						driver.findElement(By.className("session_password")).sendKeys("yourpassword");
				...
				driver.findElement(By.id("login-email")).sendKeys("youremailid");
